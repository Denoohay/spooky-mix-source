...
class PreferencesMenu extends Page
{
  ...
  function createPrefItems():Void
  {
    ...
    createPrefItemCheckbox('Song Resyncing (may lag)', 'Attempts to resync song vocals with instrumental', function(value:Bool):Void {
      Preferences.autoResyncSong = value;
    }, Preferences.autoResyncSong);
    createPrefItemCheckbox('Play Note Miss Sound', 'Plays a sound when you miss', function(value:Bool):Void {
