  ...
  **/
  ...
  public override function create():Void
  {
    ...
    */
    ...
    //this instead of the winter horrorland condiotional
    startCountdown();
  ...
  public override function update(elapsed:Float):Void
  {
    ...
    if (needsReset)
    {
      ...
      Countdown.performCountdown();
        ...
        {
            Countdown.skipCountdown(); //use this for monster's songs
        }
  ...
  override function stepHit():Bool
  {
    ...
    */
	...
	if ((currentSong?.id ?? '').toLowerCase() == 'monster')
	{
		switch (Conductor.instance.currentStep)
		{
            case 0:
	...
	if ((currentSong?.id ?? '').toLowerCase() == 'eggnog')
	{
		switch (Conductor.instance.currentStep)
		{
            //three for good measure
