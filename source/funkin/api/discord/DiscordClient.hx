...
class DiscordClient
{
  static final CLIENT_ID:String = "1293425967389474836";
  ...
  function buildPresence(params:DiscordClientPresenceParams):DiscordRichPresence
  {
    ...
    presence.largeImageText = "Friday Night Funkin': Spooky Mix";
    ...
    button1.label = "Download on Gamebanana";
    button1.url = "https://gamebanana.com/mods/551727";
    presence.buttons[0] = button1;

    final button2:DiscordButton = DiscordButton.create();
    button2.label = "Download on Gamejolt";
    button2.url = "https://gamejolt.com/games/spooky-mix/934455";
