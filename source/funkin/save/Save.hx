...
class Save
{
      ...
      unlocks:
        {
          ...
          charactersSeen: ["bf"],
          monsterTranitionsSeen: [],
          monsterSongsUnlocked: [],
          oldChar: false
        },
  ...
  public var monsterTranitionsSeen(get, never):Array<String>;

  function get_monsterTranitionsSeen():Array<String>
  {
    return data.unlocks.monsterTranitionsSeen;
  }

  public var monsterSongsUnlocked(get, never):Array<String>;

  function get_monsterSongsUnlocked():Array<String>
  {
    return data.unlocks.monsterSongsUnlocked;
  }
   ...
   * @param character
   */
  public function addMonsterTranitionsSeen(song:String):Void
  {
    if (!data.unlocks.monsterTranitionsSeen.contains(song))
    {
      trace('Song seen: ' + song);
      data.unlocks.monsterTranitionsSeen.push(song);
      trace('New songs seen list: ' + data.unlocks.monsterTranitionsSeen);
      flush();
    }
  }

  public function addMonsterSongsUnlocked(song:String):Void
  {
    if (!data.unlocks.monsterSongsUnlocked.contains(song))
    {
      trace('Song seen: ' + song);
      data.unlocks.monsterSongsUnlocked.push(song);
      trace('New songs seen list: ' + data.unlocks.monsterSongsUnlocked);
      flush();
    }
  }
...
typedef SaveDataUnlocks =
{
  ...
  var monsterTranitionsSeen:Array<String>;
  var monsterSongsUnlocked:Array<String>;
...
typedef SaveDataOptions =
{
  ...
  /**
   * Resyncs the song every beat thing. could cause lag.
   * @default `false`
   */
  var autoResyncSong:Bool;
