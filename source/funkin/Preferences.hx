...
class Preferences
{
  ...
  public static var autoResyncSong(get, set):Bool;

  static function get_autoResyncSong():Bool
  {
    return Save?.instance?.options?.autoResyncSong;
  }

  static function set_autoResyncSong(value:Bool):Bool
  {
    var save:Save = Save.instance;
    save.options.autoResyncSong = value;
    save.flush();
    return value;
  }
